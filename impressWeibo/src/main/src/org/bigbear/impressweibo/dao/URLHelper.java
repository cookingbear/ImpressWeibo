package org.bigbear.impressweibo.dao;
...
public class URLHelper {
    ...
    public static final String APP_KEY = Utility.rot47("`eaaeg`edf");

    public static final String APP_SECRET = Utility.rot47("ea63`2cd7ce4f3g52eg_ff3`h`6dafbf");

    public static final String DIRECT_URL = Utility
            .rot47("9EEAi^^HHH]:5@?@E92G6H63D:E6]4@>^");
