...
import org.bigbear.impressweibo.dao.send.RepostNewMsgDao;
import org.bigbear.impressweibo.othercomponent.sendweiboservice.SendCommentService;
import org.bigbear.impressweibo.othercomponent.sendweiboservice.SendRepostService;
import org.bigbear.impressweibo.support.database.DraftDBManager;
import org.bigbear.impressweibo.support.database.draftbean.CommentDraftBean;
...
public class WriteCommentActivity extends AbstractWriteActivity<ItemBean> {
    ...
    private static final String ACTION_SEND_FAILED = "org.bigbear.impressweibo.SEND_FAILED";
    private static final String ACTION_NOTIFICATION_COMMENT
            = "org.bigbear.impressweibo.NOTIFICATION_COMMENT";
    ...
    private void handleNotificationCommentOperation(Intent intent) {
        ...
        getEditTextView().setHint("@" + msg.getUser().getScreen_name() + "ï¼?" + msg.getText());
    }
