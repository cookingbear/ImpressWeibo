...
import org.bigbear.impressweibo.ui.loader.CommentsByMeDBLoader;
import org.bigbear.impressweibo.ui.loader.CommentsByMeMsgLoader;
...
//            ((MainTimeLineActivity) getActivity()).setCurrentFragment(this);
    ...
    private class RemoveTask extends MyAsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (aBoolean) {
                //((CommentAdapter) timeLineAdapter).removeItem(positon);
            }
        }
    }
    ...
    protected void buildListAdapter() {
        timeLineAdapter = new CommentAdapter(this,getList().getItemList());
