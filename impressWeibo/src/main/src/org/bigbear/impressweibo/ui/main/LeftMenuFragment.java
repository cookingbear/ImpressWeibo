package org.bigbear.impressweibo.ui.main;
...
import org.bigbear.impressweibo.support.database.MentionCommentsTimeLineDBTask;
...
import org.bigbear.impressweibo.support.utils.AnimationUtility;
import org.bigbear.impressweibo.support.utils.AppEventAction;
import org.bigbear.impressweibo.support.utils.GlobalContext;
import org.bigbear.impressweibo.support.utils.Utility;
import org.bigbear.impressweibo.ui.dm.DMUserListFragment;
import org.bigbear.impressweibo.ui.interfaces.AbstractAppFragment;
import org.bigbear.impressweibo.ui.login.AccountActivity;
import org.bigbear.impressweibo.ui.login.MainActivity;
import org.bigbear.impressweibo.ui.maintimeline.FriendsTimeLineFragment;
import org.bigbear.impressweibo.ui.nearby.NearbyTimeLineActivity;
import org.bigbear.impressweibo.ui.preference.SettingActivity;
import org.bigbear.impressweibo.ui.search.SearchMainParentFragment;
import org.bigbear.impressweibo.ui.userinfo.MyFavListFragment;
import org.bigbear.impressweibo.ui.userinfo.UserInfoFragment;
...
public class LeftMenuFragment extends AbstractAppFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	AppLogger.d("leftMenuFrag begin");
        final ScrollView view = (ScrollView) inflater
                .inflate(R.layout.slidingdrawer_contents, container, false);
       /* String accessToken = GlobalContext.getInstance().getAccountBean().getAccess_token();
        GroupListBean groupListBean=null;
        try {
        	AppLogger.d("groupListBean null");
			groupListBean=new FriendGroupDao(accessToken).getGroup();
		} catch (WeiboException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
        AppLogger.d("groupListBean built");
        StringBuilder groupName=new StringBuilder();
        for (GroupBean groupBean:groupListBean.getLists()){
        	groupName.append(groupBean.getName());
        	groupName.append("\n");
        }
        AppLogger.d(groupName.toString());*/
        layout = new Layout();
...
//        layout.location = (Button) view.findViewById(R.id.btn_location);
        ...
        AppLogger.d("leftMemu built successfully");
        return view;
    }
...
//                break;
    ...
    private SlidingMenu getSlidingMenu() {
        return null;//((MainTimeLineActivity) getActivity()).getSlidingMenu();
    }
