...
import org.bigbear.impressweibo.othercomponent.ConnectionChangeReceiver;
import org.bigbear.impressweibo.othercomponent.MusicReceiver;
import org.bigbear.impressweibo.support.database.AccountDBTask;
import org.bigbear.impressweibo.support.database.DatabaseManager;
...
import org.bigbear.impressweibo.ui.maintimeline.TestFragment;
...
*/
    ...
    private void initFragments() {
        ...
        //Fragment test=getTestFragment();
        //if (test==null) AppLogger.d("test null");
       ...
       // fragmentTransaction.add(R.id.menu_right_fl,test,TestFragment.class.getName() );
        //fragmentTransaction.show(test);
        /*if (!mentions.isAdded()) {
    ...
    public TestFragment getTestFragment() {
    	...
    	if (fragment==null){
    		fragment=TestFragment.newInstance(getAccount(), getUser(), getToken());
    	}
    	return fragment;
    }
