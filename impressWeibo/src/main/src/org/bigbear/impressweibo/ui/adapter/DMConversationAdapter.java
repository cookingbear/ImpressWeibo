...
public class DMConversationAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null
                || convertView.getTag(R.drawable.icon_final + getItemViewType(showPosition))
                == null) {
            ...
            convertView.setTag(R.drawable.icon_final + getItemViewType(showPosition), holder);
            convertView.setTag(R.string.listview_index_tag,
                    R.drawable.icon_final + getItemViewType(showPosition));
        } else {
            holder = (DMViewHolder) convertView
                    .getTag(R.drawable.icon_final + getItemViewType(showPosition));
        }
