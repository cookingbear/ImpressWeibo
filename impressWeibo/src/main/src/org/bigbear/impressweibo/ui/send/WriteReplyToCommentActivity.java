...
import org.bigbear.impressweibo.othercomponent.sendweiboservice.SendReplyToCommentService;
import org.bigbear.impressweibo.support.database.DraftDBManager;
import org.bigbear.impressweibo.support.database.draftbean.ReplyDraftBean;
...
public class WriteReplyToCommentActivity extends AbstractWriteActivity<CommentBean> {
    ...
    private static final String ACTION_NOTIFICATION_REPLY = "org.bigbear.impressweibo.NOTIFICATION_REPLY";
    ...
    private void handleFailedOperation(Intent intent) {
        ...
        getEditTextView().setHint("@" + bean.getUser().getScreen_name() + "ï¼?" + bean.getText());
