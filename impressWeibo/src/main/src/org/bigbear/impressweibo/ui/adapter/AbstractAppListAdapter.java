...
import org.bigbear.impressweibo.support.gallery.ViewPagerFixed;
import org.bigbear.impressweibo.support.lib.AnimationRect;
import org.bigbear.impressweibo.support.lib.ClickableTextViewMentionLinkOnTouchListener;
...
import org.bigbear.impressweibo.support.lib.TimeLineAvatarImageView;
...
//    private final int TYPE_SIMPLE = 5;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null
                || convertView.getTag(R.drawable.icon_final + itemViewType) == null) {
            View view = null;
            switch (itemViewType) {
                case TYPE_SIMPLE:
            ...
            if (itemViewType != TYPE_MIDDLE) {
                ...
                convertView.setTag(R.drawable.icon_final + getItemViewType(position), holder);
                convertView.setTag(R.string.listview_index_tag,
                        R.drawable.icon_final + getItemViewType(position));
                tagIndexList.add(R.drawable.icon_final + getItemViewType(position));
            }
        } else {
            holder = (ViewHolder) convertView
                    .getTag(R.drawable.icon_final + getItemViewType(position));
        }
        AppLogger.d("configlayertype");
        if (itemViewType != TYPE_MIDDLE) {
    ...
    private ViewHolder buildHolder(View convertView) {
        ...
        AppLogger.d("avatar");
        //holder.imageViewFrame=(FrameLayout)convertView.findViewById(R.id.imageViewFrame);
    ...
    protected void buildPic(final MessageBean msg, final IWeiciyuanDrawable view, int position,FrameLayout rootView){
    	this.rootView=rootView;
    	buildPic(msg,view,position);
    }
        ...
        if (SettingUtility.isEnablePic()) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                	...
                	//ViewPagerFixed viewPager=(ViewPagerFixed)inflater.inflate(R.id.pager, null);
                    //AbstractAppListAdapter.this.rootView.addView(viewPager);
                    //GalleryAnimationActivity.setPagerAdapter(viewPager);
    ...
    private ViewHolder getViewHolderByView(int position) {
        ...
        ViewHolder holder = (ViewHolder) wantedView
                .getTag(R.drawable.icon_final + getItemViewType(wantedPosition));
        return holder;
    }
}
