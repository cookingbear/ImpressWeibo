package org.bigbear.impressweibo.othercomponent.unreadnotification;
...
public class JBBigTextNotification {
    ...
    public Notification get() {
        ...
        if (unreadBean.getMention_status() == 1) {
            bigTextStyle.setBigContentTitle(repost.getItem(0).getUser().getScreen_name() + "ï¼?");
        ...
        if (unreadBean.getCmt() == 1) {
            bigTextStyle.setBigContentTitle(comment.getItem(0).getUser().getScreen_name() + "ï¼?");
        ...
        if (unreadBean.getMention_cmt() == 1) {
            bigTextStyle.setBigContentTitle(mentionCommentsResult.getItem(0).getUser().getScreen_name() + "ï¼?");
