package org.bigbear.impressweibo.support.error;
...
public class WeiboException extends Exception {
     ...
     * 400 Bad Request: 请求数据不合法，或�?�超过请求频率限�?. 详细的错误代码如下：
     ...
     * 40008:图片大小错误，上传的图片大小上限�?5M
     * 40001:参数错误，请参�?�API文档
     * 40002:不是对象�?属�?�，没有操作权限
     * 40010:私信不存�?
     * 40013:微博太长，请确认不超�?140个字�?
     * 40039:地理信息输入错误
     * 40040:IP限制，不能请求该资源
     * 40041:uid参数为空
     * 40042:token参数为空
     ...
     * 40029:verifier错误
     * 40027:标签参数为空
     * 40032:列表名太长，请确保输入的文本不超�?10个字�?
     * 40030:列表描述太长，请确保输入的文本不超过70个字�?
     * 40035:列表不存�?
     * 40053:权限不足，只有创建�?�有相关权限
     * 40054:参数错误，请参�?�API文档
     * 40059: 插入失败，记录已存在
     * 40060：数据库错误，请联系系统管理�?
     * 40061：列表名冲突
