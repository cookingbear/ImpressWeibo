...
import org.bigbear.impressweibo.bean.AdBean;
...
import org.bigbear.impressweibo.support.lib.MyURLSpan;
import org.bigbear.impressweibo.support.lib.WeiboPatterns;
...
public class TimeLineUtility {
    ...
    public static void addLinks(TextView view) {
        ...
        //view.setMovementMethod(TextViewFixTouchConsume.LocalLinkMovementMethod.getInstance());
        AppLogger.d("view add links");
        if (view.getLinksClickable()) {
            AppLogger.d("linksclickable");
    ...
    public static SpannableString convertNormalStringToSpannableString(String txt) {
        ...
        AppLogger.d("convertNormalStringToSpannableString");
    	String hackTxt;
        ...
        for (URLSpan urlSpan : urlSpans) {
        	AppLogger.d(urlSpan.getURL()+"|"+txt);
    ...
    public static void addJustHighLightLinks(MessageBean bean) {
    	AppLogger.d("addJustHighLightLinks");
    ...
    private static SpannableString buildOriWeiboSpannalString(MessageBean oriMsg) {
        ...
        AppLogger.d("buildOriWeiboSpannalString");
